...
### Dependencies
- Update commons-text dependency from 1.13.1 to 1.14.0 ([#318](https://github.com/personio/datadog-synthetic-test-support/pull/318))
...
- Update secretsmanager dependency from 2.31.73 to 2.33.0 ([#314](https://github.com/personio/datadog-synthetic-test-support/pull/314))
...
- Update secretsmanager dependency from 2.31.33 to 2.31.73 ([#304](https://github.com/personio/datadog-synthetic-test-support/pull/304), [#310](https://github.com/personio/datadog-synthetic-test-support/pull/310), [#326](https://github.com/personio/datadog-synthetic-test-support/pull/326)

## [3.1.1] - 2025-05-05
### Dependencies
- Update commons-text dependency from 1.13.0 to 1.13.1 ([#301](https://github.com/personio/datadog-synthetic-test-support/pull/301))
- Update datadog-api-client dependency from 2.32.0 to 2.34.1 ([#296](https://github.com/personio/datadog-synthetic-test-support/pull/296), [#300](https://github.com/personio/datadog-synthetic-test-support/pull/300))
- Update jackson-dataformat-yaml dependency from 2.18.3 to 2.19.0 ([#299](https://github.com/personio/datadog-synthetic-test-support/pull/299))
- Update jackson-module-kotlin dependency from 2.18.3 to 2.19.0 ([#299](https://github.com/personio/datadog-synthetic-test-support/pull/299))
...
- Update kotlinx-serialization-json dependency from 1.8.0 to 1.8.1 ([#302](https://github.com/personio/datadog-synthetic-test-support/pull/302))
- Update secretsmanager dependency from 2.30.31 to 2.31.33 ([#293](https://github.com/personio/datadog-synthetic-test-support/pull/293), [#297](https://github.com/personio/datadog-synthetic-test-support/pull/297))
...
- Update jackson-dataformat-yaml dependency from 2.18.2 to 2.18.3 ([#288](https://github.com/personio/datadog-synthetic-test-support/pull/288))
- Update jackson-module-kotlin dependency from 2.18.2 to 2.18.3 ([#288](https://github.com/personio/datadog-synthetic-test-support/pull/288))
...
- Update kotlinx-serialization-json dependency from 1.7.3 to 1.8.0 ([#280](https://github.com/personio/datadog-synthetic-test-support/pull/280))
- Update secretsmanager dependency from 2.29.43 to 2.30.31 ([#282](https://github.com/personio/datadog-synthetic-test-support/pull/282), [#286](https://github.com/personio/datadog-synthetic-test-support/pull/286))
...
- Update datadog-api-client dependency from 2.30.0 to 2.31.0 ([#271](https://github.com/personio/datadog-synthetic-test-support/pull/271))
...
- Update kotlin-stdlib dependency from 2.0.20 to 2.1.0 ([#252](https://github.com/personio/datadog-synthetic-test-support/pull/252), [#262](https://github.com/personio/datadog-synthetic-test-support/pull/262))
...
- Update secretsmanager dependency from 2.27.17 to 2.29.24 ([#241](https://github.com/personio/datadog-synthetic-test-support/pull/241), [#256](https://github.com/personio/datadog-synthetic-test-support/pull/256), [#263](https://github.com/personio/datadog-synthetic-test-support/pull/263))
