...
/**
 * Configure the alert message to be sent when the test fails
 ...
 * Example : Slack channel -> @slack-not_synthetic_alert
...
/**
 * Configure the recovery message when the test recovers
