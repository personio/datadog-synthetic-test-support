...
internal class TargetElementTest {
    ...
    @Test
    fun `getSpecialActionsElementObject returns the Element for special actions object with passed locator value and default locator type`() {
        val locator = "#locator"
    ...
    @Test
    fun `getSpecialActionsElementObject returns the Element for special actions object with passed locator value and locator type`() {
        val locator = "#locator"
        val locatorType = LocatorType.XPATH
    ...
    private fun userLocator(locator: String, locatorType: LocatorType = LocatorType.CSS): UserLocator =
